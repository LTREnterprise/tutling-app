...
import { IonicPage, NavController, NavParams, Keyboard, LoadingController } from 'ionic-angular';
...
/**
 * Generated class for the TutorChatPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-tutor-chat',
  templateUrl: 'tutor-chat.html',
})
export class TutorChatPage {
  user;
  path;
  mssg = ""
  Messages = new Array();
  ...
  //tutor
      ...
      this.methods.getMessages2(this.path).then((data:any) =>{
